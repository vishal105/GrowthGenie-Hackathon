...
def main():
    ...
    return final_dataframe, final_dataframe1, final_dataframe2, fixed_top, mutual_top, stock_top, new_data
if __name__ == '__main__':
    final_dataframe, final_dataframe1, final_dataframe2, fixed, mutual, stock, new_data = main()
